...
def manual_control():
	...
	layout_manualControl = [
	   ...
	   [sg.Button('+100 nm', size=(8, 1), key='+100'), sg.Button('+10 nm', size=(7, 1), key='+10'), sg.Button('+1 nm', size=(7, 1), key='+1'), sg.Button('+0.1 nm', size=(7, 1), key='+0.1')],
	   [sg.Text('Current excitation: ', size=(15, 1)), sg.Text(str(exVal/10), size=(4, 1), key='exVal')],
	   [sg.Text('Current emition: ', size=(15, 1)), sg.Text(str(emVal/10), size=(4, 1), key='emVal')],
	...
	while True:
		 ...
		 if manCtrl_event in (None, 'Quit'):
			  ...
			  if values['ex']:
				   exVal = exVal + val
				   window_manualControl['exVal'].Update(exVal/10)
			  else:
				   emVal = emVal + val
				   window_manualControl['emVal'].Update(emVal/10)

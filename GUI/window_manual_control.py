...
def manual_control(pin_list_ex, pin_list_em):
    ...
    layout_manualControl = [
        ...
        [sg.Button('', size=(8, 1), key='-100', image_filename='assets/buttons/-100.png', image_size=(80,80), border_width=0), 
        	sg.Button('', size=(7, 1), key='-10', image_filename='assets/buttons/-10.png', image_size=(80,80), border_width=0),
            sg.Button('', size=(7, 1), key='-1', image_filename='assets/buttons/-1.png', image_size=(80,80), border_width=0), 
            sg.Button('', size=(7, 1), key='-0.1', image_filename='assets/buttons/-0.1.png', image_size=(80,80), border_width=0),
            sg.Button('', size=(7, 1), key='+0.1', image_filename='assets/buttons/+0.1.png', image_size=(80,80), border_width=0),
            sg.Button('', size=(7, 1), key='+1', image_filename='assets/buttons/+1.png', image_size=(80,80), border_width=0), 
            sg.Button('', size=(8, 1), key='+10', image_filename='assets/buttons/+10.png', image_size=(80,80), border_width=0), 
        	sg.Button('', size=(7, 1), key='+100', image_filename='assets/buttons/+100.png', image_size=(80,80), border_width=0)
        ],

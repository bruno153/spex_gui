...
def exp_setup(pin_list):
	...
	layout = [
		...
		[sg.Text('Excitation', size=(20,1)), sg.Input('300', size=(4,1), key='input_ex_st'), sg.Text('nm', justification='left'),
			sg.Input('600', size=(4,1), key='input_ex_en'), sg.Text('nm', justification='left')],
		[sg.Text('Emission', size=(20,1)), sg.Input('100', size=(4,1), key='input_em_st'), sg.Text('nm', justification='left'),
			sg.Input(size=(4,1), disabled=True, key='input_em_en'), sg.Text('nm', justification='left')],
		[sg.Text('Increment', size=(20,1)), sg.Input('1', size=(4,1), key='input_in_nm'), sg.Text('nm', justification='left'), sg.Input(size=(4,1), disabled=True, key='input_in_s'), sg.Text('s', justification='left')],
